...
PROMPT="%F{red}┌%f%F{green}[%n]%f%F{red}─%f%F{cyan}[%m]%f%F{red}─%f%F{magenta}[%d%f%F{red}]%f"$'\n'"%F{red}└╼%f%F{yellow}$%f"
...
#enable Z Colors
#source ~/Aplicaciones/zcolors/zcolors.plugin.zsh
#source ~/.zcolors

####################################################################################
#
### EXTRA - Funciones creadas por de S4VITAR https://github.com/s4vitar
#
####################################################################################
